...
# Ganti nilai anomali dan karakter non-numerik menjadi NaN
...
plt.plot(test_preds_inv, label='Prediksi')
plt.xlabel('Data Index')
plt.ylabel('Curah Hujan (mm)')
plt.title('Prediksi vs Aktual Curah Hujan (Semua Fitur)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()

# 10. Hindcast Interaktif
...
plt.title('Feature Importance (Random Forest - Semua Fitur)')
