...
# 1. Baca data
df = pd.read_excel("E:/STMKG/SKRIPSI/datahujan/fix/Data_AWS_Per_3_Jam_Outlier.xlsx")
...
summary_df.to_excel("E:/STMKG/SKRIPSI/datahujan/fix/summary_aws_cleaning_suggestions_Jam_After.xlsx", index=False)
