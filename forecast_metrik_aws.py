...
print("\nMelatih model LSTM dengan perbaikan...")
params_lstm = {'units': 128, 'dropout': 0.3, 'learning_rate': 0.00534, 'epochs': 200} # Epochs ditingkatkan
...
# --- PERBAIKAN UTAMA: Menambahkan EarlyStopping Callback ---
# Model akan berhenti jika 'val_loss' tidak membaik selama 10 epoch
...
model_lstm.fit(
    ...
    callbacks=[early_stopping] # Terapkan early stopping
)
...
print("\n" + "="*50)
print("HASIL EVALUASI KINERJA MODEL LSTM (FORECASTING - AWS)")
print("="*50)
