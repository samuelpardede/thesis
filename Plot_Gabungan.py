...
print("\nMembuat Scatter Plot Aktual vs. Prediksi...")
...
# Buat subplot untuk masing-masing model
fig, axes = plt.subplots(1, 3, figsize=(20, 6), sharex=True, sharey=True)
fig.suptitle('Scatter Plot: Nilai Aktual vs. Prediksi untuk Setiap Model (Data AWS)', fontsize=18)

models_to_plot = {
    "Random Forest": ('Prediksi RF', 'green'),
    "XGBoost": ('Prediksi XGBoost', 'red'),
    "LSTM": ('Prediksi LSTM', 'blue')
}

# Loop untuk membuat plot untuk setiap model
